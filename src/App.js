...
function App() {
  ...
  const handleInput = () => {
    ...
    let welcome = [
      "HI||Hi||hi|hello|Hello|hey|sup|yo|wassup|whats up|howdy|greetings|good morning|good afternoon|good evening|Good Morning",
    ];
    ...
    if (one.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "This is transactional error.";
        status.innerText = "Active";
        status.style.color = "green";
        inputRef.value = ""; // clear the input
      }, 2000);
    ...
    if (two.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "This is cashback related queries.";
        status.innerText = "Active";
        status.style.color = "green";
        inputRef.value = ""; // clear the input
      }, 2000);
    ...
    if (three.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "This is billing related queries.";
        status.innerText = "Active";
        status.style.color = "green";
        inputRef.value = ""; // clear the input
      }, 2000);
    ...
    if (four.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "This is other queries.";
        status.innerText = "Active";
        status.style.color = "green";
        inputRef.value = ""; // clear the input
      }, 2000);
        ...
        <div className="content">
          <div className="header">
            ...
            <div className="right">
              ...
              <div className="group-name">EDI Group-53</div>
